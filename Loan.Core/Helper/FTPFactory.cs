...
namespace Loan.Core.Helper
{
    ...
    public class FTPFactory
    {
        ...
        /// FTP服务器地址
        /// </summary>
        /// <value>服务器地址，如ftp://192.168.21.28:22</value>
        public Uri Uri
        {
            get
            {
        ...
        /// <example>
        /// <code>
        ///   FTPFactory _FTP =  new FTPFactory(new Uri("ftp://192.168.21.28:22"), "UserName", "Password");
        /// </code>
        /// </example>
        public FTPFactory(Uri FtpUri, string strUserName, string strPassword)
        {
        ...
        public FTPFactory(Uri FtpUri, string strUserName, string strPassword, WebProxy objProxy)
        {
            this._Uri = new Uri(FtpUri.GetLeftPart(UriPartial.Authority));
            _DirectoryPath = FtpUri.AbsolutePath;
            if (!_DirectoryPath.EndsWith("/"))
        ...
        /// </summary>
        /// <param name="RemoteFileName">远程文件名，如:FILE.EXE</param>
        /// <param name="LocalPath">本地路径,如;"D:\我的工作\"</param>
        /// <remarks>
        /// 下载文件到本地指定路径,下载时不会弹出保存确认框；
        /// </remarks>
        /// <example>
        ///    <code>
        ///    _ftp.DownloadFile("filename.txt","D:\我的工作\")
        ///    </code>
        /// </example>
        ...
        /// <param name="LocalFilePath">保存文件的本地路径,后面带有"\",如："D:\我的工作\"</param>
        ...
        private FileStruct ParseFileStructFromWindowsStyleRecord(string Record)
        {
            ...
            else
            {
                ...
                string str = processstr.Substring(processstr.IndexOf(' ', 0) + 1);
                processstr = str;
        ...
        /// <returns></returns>
        public FileStruct FileInfo(string RemoteFileName)
        {
            try
            {
                if (!IsValidFileChars(RemoteFileName))
